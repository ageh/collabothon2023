    ...
    <ModalContent>
      ...
      <ModalBody>
        <div className="w-full text-center mt-5">
          ...
          <h2 className="font-bold my-5">Rate John</h2>
          ...
          <div className="items-center space-x-1 mt-5">
            <img
      ...
      return (
        <>
          ...
          <p className="text-sm text-gray-400 text-center">
            ...
            person, please first scan the QR code thats shown on the giver's
            phone.
          </p>
        </>
      );
      ...
      return (
        <>
          <p className="text-md text-gray-800 text-center">
            ...
            <br />
            Please confirm that you want to proceed and transfer the following
            amount to him/her:
          </p>
    ...
    if (activeStepIdx === 2)
      return (
        <>
          ...
          <p className="text-md text-gray-800 text-center">
            After XYZ handed the cash to you, please confirm that you've
            actually received the following amount:
          </p>
          <h2 className="font-medium text-2xl cc--text-primary text-center">
            30 €
          </h2>
      ...
      return (
        <div>
          <Button
            ...
            color="success"
            variant="solid"
            onClick={() => setModalContent(successModalContent)}
          >
            <CheckOutlined />
